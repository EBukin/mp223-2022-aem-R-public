...
## 🖥 [W03-00 Data ](/slides/50-data-wrangling/50-wrangling-intro.html)[Workflow](/slides/50-data-wrangling/workflow-tidy-data-wrangling.html)[+ Tidy data + Wrangling](/slides/50-data-wrangling/50-wrangling-intro.html)

-   **In class**:
    -   slides [W03-00 Data ](/slides/50-data-wrangling/50-wrangling-intro.html)[Workflow](/slides/50-data-wrangling/workflow-tidy-data-wrangling.html)[+ Tidy data + Wrangling](/slides/50-data-wrangling/50-wrangling-intro.html)
...
## 🖥 [W03-01 Import data](/slides/50-data-wrangling/import-data.html) `readr` + `readxl` + `janitor`

-   **In class**:
    -   **exercise** [`ae03-01-import-clean-sum-plot.Rmd`](/ae/ae03-data-wrangling/ae03-01-import-clean-sum-plot.html)
-   **`SELF STUDY` slides** [W03-02 Import data](/slides/50-data-wrangling/import-data.html)
-   **Recommended.** Watch:
...
## 🖥 [W03-02 Exploring numerical data](/slides/50-data-wrangling/import-data.html)
...
## 🖥 [W03-03 correlation `correlation`](/slides/20-data-description/correlation.html)

-   **In class**:
    -   **slides** [W03-04 correlation `correlation`](/slides/20-data-description/correlation.html)
-   **`SELF STUDY` exercise** [`ae03-03-correlation.Rmd`](/ae/ae03-data-wrangling/ae03-03-correlation.html)
-   **Recommended**. Read:
...
## 🖥 **`SELF STUDY`** [W03-04 Exploring categorical data](/slides/20-data-description/correlation.html)

-   **`SELF STUDY` exercise: TBD**
-   **Optional.** Read:
...
We use `dplyr` every day in any exercise. Thus, there is no point to dedicate time to it. use slides and the list of materials below to guide your learning process.
