...
::: {.column width="30%"}
::: {.smaller}
$Y = \color{green}{f(X)} + \text{Error term} \\ 
= \color{green}{E[Y|X]} + \epsilon
$
:::
:::
...
::: {.column width="30%"}
$Y = 
\color{green}{f(X)} + \color{blue}{\text{Error term}} \\ 
= \color{green}{E[Y|X]} + \color{blue}{\epsilon}$
:::
...
-   regression summary: `summary()`, `tidy()`, `glance()`, `parameters()` and `performance()`
