...
#| echo: false
options(width = 350)
un_dta %>% group_by(group) %>% report() %>% as_tibble() %>% print(n = 40)
options(width = 90)
```
...
::::  callout-important
Check out [https://www.r-graph-gallery.com/boxplot.html](https://www.r-graph-gallery.com/boxplot.html);

Boxplot explanation: [https://www.data-to-viz.com/caveat/boxplot.html](https://www.data-to-viz.com/caveat/boxplot.html)
::::

:::: footer
Image source: [https://www.leansigmacorporation.com/box-plot-with-minitab/](https://www.leansigmacorporation.com/box-plot-with-minitab/)
::::
...
::::  callout-important
Check the gallery [https://r-graph-gallery.com/histogram.html](https://r-graph-gallery.com/histogram.html);
...
::::  callout-important
Check the gallery [https://r-graph-gallery.com/density-plot](https://r-graph-gallery.com/density-plot);

Learn about density plots here: [https://www.data-to-viz.com/graph/density.html](https://www.data-to-viz.com/graph/density.html)
::::
...
Check the gallery [https://r-graph-gallery.com/scatterplot.html](https://r-graph-gallery.com/scatterplot.html);

Learn more about scatter plots here: [https://www.data-to-viz.com/graph/scatter.html](https://www.data-to-viz.com/graph/scatter.html)
